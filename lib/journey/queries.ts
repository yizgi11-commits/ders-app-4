...
import { JOURNEY_DAYS, type JourneyDay, type JourneyResponse } from './types'

// ─────────────────────────────────────────────────────────────────
// Journey — shared with app/api/journey/route.ts (client refetch,
// currently unused but kept for future mutation flows) and the
// server-rendered Journey page, so the bucketing logic lives once.
// ─────────────────────────────────────────────────────────────────
